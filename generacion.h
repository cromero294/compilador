...
es_var indica si este operando es una variable (como por ejemplo b1) u otra cosa (como por ejemplo 34). Recuerda que en el primer caso internamente se representará com _b1 y, sin embargo, en el segundo se representará tal y como esté en el argumento (34)
*/
